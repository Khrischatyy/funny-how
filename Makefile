...
seeds-prod:
	@docker-compose -f docker-compose.yml -f prod.yml run --rm backend sh -c "php artisan db:seed --class=RoleSeeder --force && php artisan db:seed --class=OperatingHoursSeeder --force"
