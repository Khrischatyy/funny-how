      ...
      <div class="w-full h-full grid items-center justify-center mb-10">
        <div class="relative bottom-[10%] flex-col justify-start items-center gap-7 inline-flex">
          ...
          <div class="relative h-full min-h-[500px] forms flex justify-start items-center">
            ...
            <create-form v-if="step == 'create' && !session?.isAuthorized" ref="create" :class="step == 'create' ? 'translate-x-[0px] duration-[700ms]' : 'ml-96 translate-x-96 duration-700 opacity-0'" class="relative w-full flex-col justify-start items-center gap-2.5 flex"/>
            ...
            <div v-if="session?.isAuthorized" ref="authorized" :class="session?.isAuthorized ? 'translate-x-[0px] duration-[700ms]' : 'opacity-0 -translate-x-96 duration-700'" class="relative w-full flex-col justify-start items-center gap-2.5 flex">
              ...
              <div class="w-96 justify-between items-start inline-flex">
                <div class="text-white text-xl font-bold tracking-wide">Setup Your Account</div>
              </div>
              ...
              <div class="flex-col justify-start items-start gap-1.5 flex">
                <div class="w-96 justify-between items-start inline-flex">
                  ...
                  <div :class="isError('setup', 'studio_name') ? '' : 'hidden'" class=" text-right text-red-500 text-sm font-normal tracking-wide">{{ isError('setup', 'studio_name') }}</div>
                </div>
                <div class="justify-start items-center w-full gap-2.5 inline-flex">
                  <div class="justify-center w-96 items-center gap-2.5 inline-flex">
                    ...
                    <input v-model="getFormValues('setup')['studio_name']" class="w-full h-11 px-3.5 py-7 outline-none rounded-[10px] focus:border-white border border-white border-opacity-20 bg-transparent text-white text-sm font-medium tracking-wide" type="text" placeholder="Enter Your Studio Name" />
                  </div>
                </div>
              </div>
              ...
              <div class="flex-col justify-start items-start gap-1.5 flex">
                <div class="w-96 justify-between items-start inline-flex">
                  ...
                  <div :class="isError('setup', 'address') ? '' : 'hidden'" class=" text-right text-red-500 text-sm font-normal tracking-wide">{{ isError('setup', 'address') }}</div>
                </div>
                <div class="justify-start items-center gap-2.5 inline-flex">
                  <input id="place" v-model="getFormValues('setup')['address']" class="w-96 h-11 px-3.5 py-7 outline-none rounded-[10px] focus:border-white border border-white border-opacity-20 bg-transparent text-white text-sm font-medium tracking-wide" type="text" placeholder="Enter Your Address" />
                </div>
              ...
              <div class="flex-col justify-start items-start gap-1.5 flex">
                <div class="w-96 justify-between items-start inline-flex">
                  ...
                  <div :class="isError('setup', 'about') ? '' : 'hidden'" class=" text-right text-red-500 text-sm font-normal tracking-wide">{{ isError('setup', 'about') }}</div>
                </div>
                <div class="justify-start items-center gap-2.5 inline-flex">
                  <textarea name="about" type="text" v-model="getFormValues('setup')['about']" :class="{'border-red': isError('setup', 'about') || isError('setup', 'about')}" class="w-96 h-20 no-scrollbar px-3.5 py-3.5 outline-none rounded-[10px] focus:border-white border border-white border-opacity-20 bg-transparent text-white text-sm font-medium tracking-wide"/>
                </div>
              </div>
              <div class="justify-center items-center gap-2.5 inline-flex">
